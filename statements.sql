...
-- Tu respuesta aquí
SELECT COUNT(lenguaje) FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
-- Tu respuesta aquí
SELECT nombre, COUNT(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes GROUP BY nombre;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (SELECT MAX(LENGTH(lenguaje)) FROM usuarios_lenguajes WHERE edad < 30) AND edad < 30;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (SELECT MIN(LENGTH(lenguaje)) FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%')AND lenguaje LIKE 'J%';
...
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (SELECT MAX(LENGTH(lenguaje)) FROM usuarios_lenguajes WHERE edad >= 30);
